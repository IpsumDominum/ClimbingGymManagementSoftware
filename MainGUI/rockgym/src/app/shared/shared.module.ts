...
import { TenderModalComponent } from './modals/tender-modal/tender-modal.component';
import { SignaturePadModule } from 'ngx-signaturepad';
import { MembershipHolidayComponent } from './modals/membership-holiday/membership-holiday.component';
import { ViewMemberContactInfoComponent } from './modals/view-member-contact-info/view-member-contact-info.component';
import { EditQtyComponent } from './modals/edit-qty/edit-qty.component';
import {WebcamModule} from 'ngx-webcam';
import { DiscountAmountComponent } from './modals/discount-amount-modal/discount-amount-modal';
import { EftposMenuModalComponent } from './modals/eftpos-menu-modal/eftpos-menu-modal.component';
...
@NgModule({
  declarations: [
    ...
    MembershipHolidayComponent,
    ViewMemberContactInfoComponent,
    EditQtyComponent,    
    DiscountAmountComponent,
    EftposMenuModalComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
